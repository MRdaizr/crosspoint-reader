...
bool renderPass(GfxRenderer& renderer, const Rect& bounds, const SelectedImage& selected, ImageBlock* jpegBlock) {
  switch (selected.image.format) {
    ...
    case ImageFormat::Jpeg:
      return jpegBlock && jpegBlock->renderChecked(renderer, bounds.x, bounds.y);
  }
  return false;
}
...
void AirPageImageRenderer::resetSessionFailures() {}

void AirPageImageRenderer::releaseSessionResources() {}
