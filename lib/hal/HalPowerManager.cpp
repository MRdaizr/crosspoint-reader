...
void HalPowerManager::begin() {
  // HalGPIO still uses the X3 fuel-gauge current register to detect USB
  // charging. Keep the shared I2C bus initialized even though FreeInk's
  // BatteryMonitor handles percentage reads through BoardConfig.
  if (gpio.deviceIsX3()) {
...
void HalPowerManager::startDeepSleep(HalGPIO& gpio) const {
  ...
  // FreeInk owns the board-specific sleep rails. GPIO13 remains the battery
