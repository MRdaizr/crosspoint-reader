...
// Shelf covers are cached at a larger size because the single-book shelf view
// can display them well above the original thumbnail dimensions.
constexpr int kCoverThumbWidth = 320;
constexpr int kCoverThumbHeight = 468;
